...
//        PersonDetailsDTO p = new PersonDetailsDTO("John", "Somewhere Else street", 22, "client");
//        int insertedID = personService.insert(p);
//
//        PersonDetailsDTO insertedPerson = new PersonDetailsDTO(insertedID, p.getName(),p.getAddress(), p.getAge(), p.getRole());
